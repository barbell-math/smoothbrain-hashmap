...
dlv test --build-flags="-tags=simd128" github.com/barbell-math/smoothbrain-hashmap  # or...
dlv test --build-flags="-tags=simd256" github.com/barbell-math/smoothbrain-hashmap  # or...
dlv test --build-flags="-tags=simd512" github.com/barbell-math/smoothbrain-hashmap
```
...
go test -tags=simd128 -gcflags "-N" -ldflags="-compressdwarf=false" -c ./...    # or...
go test -tags=simd256 -gcflags "-N" -ldflags="-compressdwarf=false" -c ./...    # or...
go test -tags=simd512 -gcflags "-N" -ldflags="-compressdwarf=false" -c ./...
...
breakpoints is not as easy but, it can see the xmm/ymm/zmm registers. Pick your
poison.
